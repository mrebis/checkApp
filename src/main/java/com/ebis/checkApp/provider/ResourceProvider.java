...
import com.ebis.checkApp.provider.factory.YamlPropertySourceFactory;
...
public class ResourceProvider {
	...
	@Value("${client.email.actualdate.param}")
	private String clientActualDateParam;
	...
	public String getClientActualParam() {
		return clientActualDateParam;
	}
