package com.ebis.checkApp.exception;
...
import com.ebis.checkApp.domain.HttpResponse;
import com.ebis.checkApp.exception.domain.EmailExistException;
import com.ebis.checkApp.exception.domain.EmailNotFoundException;
import com.ebis.checkApp.exception.domain.EmailNotVerifiedException;
import com.ebis.checkApp.exception.domain.TaskNotFoundException;
...
public class ExceptionHandling implements ErrorController {
	...
	private static final String NO_CREDITS = "You do not have sufficient credits";
...
//	public ResponseEntity<HttpResponse> insufficientCreditsException(InsufficientCreditsException ex) {
//		return this.createHttpResponse(NO_CREDITS, String.format(METHOD_IS_NOT_ALLOWED));
//	}
	...
	public ResponseEntity<HttpResponse> feedNotFoundException(TaskNotFoundException ex) {
	    return this.createHttpResponse(BAD_REQUEST, ex.getMessage());
	}
